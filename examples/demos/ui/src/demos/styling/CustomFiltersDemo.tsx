      ...
      info={
        <>
          <P>
            ...
            click point — and the pinch follows the cursor while you drag
            pressed. A bulge displacing past the 16px outset clips at the layer
            edge — findable at the slider extremes.
          </P>
          <CodeTabs
            tsx={`<node
  style={{

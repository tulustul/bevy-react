...
function serializeProps(id, props) {
  ...
  for (const [key, value] of Object.entries(props)) {
    ...
    else if (key === "imageMode") out.imageMode = value;
  }
...
// src/generated.ts
function emit2(name, value) {
  emit(name, value);
}
function request2(name, value) {
...
function removeEventListener2(name, cb) {
...
var bevy = {
  ...
  cubes: {
    get() {
      return request2("cubes.get", null);
    }
  }
};
...
function App() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("node", { style: modalStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("image", { src: "bevy-logo.png", style: { width: 100 } }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("text", { style: { color: "#cdd6f4", fontSize: 22, fontWeight: "bold" }, children: [
      "Cubes: ",
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { style: { color: "#7aa2f7" }, children: count })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("node", { style: { flexDirection: "row", gap: 12 }, children: [
...
// src/index.tsx
await mount(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(App, {}));

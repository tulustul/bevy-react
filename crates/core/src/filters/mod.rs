...
//! eight built-ins), `transition` (whole-value `filter` transition planning),
...
pub use builtin::{
    BlurParams, BrightnessParams, ContrastParams, GrayscaleParams, HueRotateParams, InvertParams,
    SaturateParams, SepiaParams, register_builtin_filters,
};
pub use params::{
